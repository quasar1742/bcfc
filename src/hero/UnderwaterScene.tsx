  ...
  return (
    <div className="ocean-details">
      ...
      <svg className="ocean-jelly ocean-jelly--one" viewBox="0 0 110 150">
        <path d="M14 65C14 25 32 9 55 9s41 16 41 56Z" fill="#c78278" />
        <path d="M14 65c9 13 18 13 27 0 9 13 18 13 27 0 9 13 18 13 28 0" fill="none" stroke="#edc7af" strokeWidth="6" strokeLinecap="round" />
        <path d="M31 76c-9 24 11 39 0 66M53 76c11 24-10 42 1 67M77 76c-11 22 8 39-3 62" fill="none" stroke="#c78278" strokeWidth="6" strokeLinecap="round" />
        <ellipse cx="41" cy="45" rx="4" ry="7" fill="#855b5b" />
        <ellipse cx="68" cy="45" rx="4" ry="7" fill="#855b5b" />
      </svg>

      <svg className="ocean-jelly ocean-jelly--two" viewBox="0 0 110 150">
        <path d="M14 65C14 25 32 9 55 9s41 16 41 56Z" fill="#75aaa1" />
        <path d="M14 65c9 13 18 13 27 0 9 13 18 13 27 0 9 13 18 13 28 0" fill="none" stroke="#d8ebe0" strokeWidth="6" strokeLinecap="round" />
        <path d="M31 76c-9 24 11 39 0 66M53 76c11 24-10 42 1 67M77 76c-11 22 8 39-3 62" fill="none" stroke="#75aaa1" strokeWidth="6" strokeLinecap="round" />
      </svg>
    </div>
  )
}
...
function Reef() {
  return (
    ...
    >
      ...
      <g opacity=".5">
        <path d="M0 325c70-58 118-52 167 0 43-82 107-92 177-2 49-59 103-55 153 7Z" fill="#285767" />
        <path d="M1115 326c52-67 105-69 157-4 50-88 116-89 181 0 43-46 91-45 147 8Z" fill="#285767" />
      </g>
      ...
      <g transform="translate(255 285)">
        <path d="M-105 94c3-85 28-127 75-127 38 0 40 46 65 47 28 1 40-55 78-42 40 14 28 76 55 81 30 5 44-37 81-12 18 12 22 31 20 53Z" fill="#c96f5d" />
        <path d="M-58 95c5-52 20-77 44-77 22 0 20 40 39 42 22 2 28-50 58-39 27 10 20 55 45 58 18 2 27-14 45-8l14 24Z" fill="#e7b853" opacity=".88" />
      </g>
      <g transform="translate(1236 314)">
        <path d="M-145 66c21-59 59-89 108-88 43 1 56 34 88 38 42 5 59-25 99-12 28 9 48 29 58 62Z" fill="#745f67" />
        <path d="M-70 62c10-35 29-58 57-61 24-3 35 20 54 17 23-4 30-33 56-25 25 8 30 39 53 45 15 4 29 2 41 4l17 24Z" fill="#58999a" />
      </g>
      ...
      <g className="reef-fan" transform="translate(622 343)" fill="none" stroke="#cf7666" strokeWidth="7" strokeLinecap="round">
